...
export default function page(){
    return(
        <div>
            ...
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/save"><Image src="/bookmark.png" width={32} height={32} alt="Save Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/save" title="save icons">Save icons created by Anggara - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/list"><Image src="/list.png" width={32} height={32} alt="List Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/list" title="list icons">List icons created by Chanut - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/hamburger"><Image src="/hamburger.png" width={32} height={32} alt="Hamburger Icon"/></a>
            ...
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/user"><Image src="/user.png" width={32} height={32} alt="User Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/user" title="user icons">User icons created by Freepik - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/settings"><Image src="/setting.png" width={32} height={32} alt="Settings Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/settings" title="settings icons">Settings icons created by Freepik - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/redirect"><Image src="/share.png" width={32} height={32} alt="Redirect Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/redirect" title="redirect icons">Redirect icons created by IconKanan - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/visibility"><Image src="/visibility.png" width={32} height={32} alt="Visibility Icon"/></a>
            ...
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/read"><Image src="/logo.png" width={32} height={32} alt="Read Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/read" title="read icons">Read icons created by Freepik - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/plus"><Image src="/add-black.png" width={32} height={32} alt="Plus Icon"/></a>
                <a href="https://www.flaticon.com/free-icons/plus" title="plus icons">Plus icons created by dmitri13 - Flaticon</a>
            </p>
            <p className="flex items-center space-x-5">
                <a href="https://www.flaticon.com/free-icons/filter"><Image src="/filter-black.png" width={32} height={32} alt="Filter Icon"/></a>
